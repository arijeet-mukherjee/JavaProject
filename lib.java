...
public class lib {
	 ...
	 public static class ex{
	    ...
	    public static void login() {
	        ...
	        login_but.setBackground(SystemColor.info);
	        login_but.setForeground(SystemColor.activeCaptionText);
	        ...
	        login_but.addActionListener(new ActionListener() {  //Perform action
	            ...
	            String password = F_pass.getText().toString(); //Store password entered by the user in the variable "password"
